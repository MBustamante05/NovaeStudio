...
export const ServiceBtn = ({ text, className, center = true }: ServiceBtnProps) => {
  return (
    <div className={`flex ${center ? "items-center justify-center" : ""}`}>
      <div className="relative group">
        <button className={`relative inline-block p-px font-semibold text-white bg-neutral-800 shadow-2xl cursor-pointer rounded-2xl shadow-indigo-900 transition-all duration-300 ease-in-out hover:scale-105 active:scale-95 hover:shadow-indigo-600 ${className}`}>
